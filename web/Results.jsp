...
try{
	...
	String sql="select e.usn,p.s_fname,p.s_lname from student_personal_info p,student_academic_details d,extra_curricular e where p.stud_id=d.stud_id and d.usn=e.usn and p.stud_id = ?";
